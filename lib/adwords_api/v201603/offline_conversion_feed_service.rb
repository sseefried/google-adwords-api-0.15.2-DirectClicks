...
require 'adwords_api/v201603/offline_conversion_feed_service_registry'

module AdwordsApi; module V201603; module OfflineConversionFeedService
  class OfflineConversionFeedService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201603::OfflineConversionFeedService
    end
  end
end; end; end
