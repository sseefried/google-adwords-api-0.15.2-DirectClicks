...
require 'adwords_api/v201603/shared_set_service_registry'

module AdwordsApi; module V201603; module SharedSetService
  class SharedSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201603::SharedSetService
    end
  end
end; end; end
