...
require 'adwords_api/v201603/campaign_shared_set_service_registry'

module AdwordsApi; module V201603; module CampaignSharedSetService
  class CampaignSharedSetService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201603::CampaignSharedSetService
    end
  end
end; end; end
