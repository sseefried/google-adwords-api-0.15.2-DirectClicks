...
require 'adwords_api/v201603/account_label_service_registry'

module AdwordsApi; module V201603; module AccountLabelService
  class AccountLabelService < AdsCommon::SavonService
    ...
    def get_module()
      return AdwordsApi::V201603::AccountLabelService
    end
  end
end; end; end
